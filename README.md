...
Authors: Sagar Kania, Lisa Otten, Robert J. Webber, Gideon Simpson, David Aristoff, and Daniel M. Zuckerman
...
— without requiring long trajectories or predefined discrete states. This code is based on the methods described in the pre-prints:
...
Pre-print: Regularized RiteWeight for Sparse Trajectory Data: A Smoothed Stationary Reweighting Framework. https://doi.org/10.26434/chemrxiv.15001337
---
Installation:
...
Since release, we have added a smoothing feature that allows for a more consistent analysis of sparse trajectory data.
