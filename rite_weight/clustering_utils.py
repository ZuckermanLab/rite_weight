...
class RandomClustering:
    def __init__(self, trans_from_feat, trans_to_feat, total_clusters,seed=42):
    ...
    def get_random_clusters_cdist(self, ref_segs_feat):
        idx = self.rng.choice(ref_segs_feat.shape[0], size=self.total_clusters, replace=False)
